...
public class  WeatherActivity3 extends AppCompatActivity {
    Intent intent;
    private static final String TAG = "WeatherActivity3";

    private ScrollView weatherLayout3;
...
//    private String mWeatherId2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化各控件
        weatherLayout3 = (ScrollView) findViewById(R.id.weather_layout3);
...
//        sportText.setText(sport);
        weatherLayout3.setVisibility(View.VISIBLE);
